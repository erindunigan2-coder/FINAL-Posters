...
Poster Number: 224
Title: "Cleaning -- EN (Mid Phos)"
Document Type: Construction Workup
Status: v1.0 -- Ready for Generation
Created: 2026-04-26T00:00:00
Author: Alaina (alaina-poster-designer)
Source Documents:
  - "Electroless Clusters -- Watson Research Brief (Process 2: EN Mid-P, Poster 2)"
Process Scope: Alkaline soak cleaning for electroless nickel mid phosphorus line (Stage 1 of 7)
...
# Poster #224 -- Construction Workup
## Cleaning -- EN (Mid Phos)

*Alaina -- Plating Posters Inc Creative Lead*
*v1.0 -- 2026-04-26*

Stage 1 of the EN Mid-P process. Cleaning chemistry is identical to EN Low-P -- the same alkaline soak cleaner removes the same contaminants. Watson's brief confirms that Mid-P baths, running hotter (85-91 C) and at acid pH, are slightly more tolerant of marginal cleaning than Low-P. But "more tolerant" is not "tolerant." Skip plating from contamination remains the #1 defect in EN operations regardless of phosphorus class. If the surface is not catalytically clean, the autocatalytic reaction will not start -- and no amount of current can force it because there is no current.

Hero visual: a tank cross-section showing parts immersed in alkaline soak cleaner with agitation arrows and soil removal dynamics. Mirrors Poster #216 structure.
...
**Subheading:** `EN (Mid Phos) -- Stage 1 of 7` -- Barlow SemiBold, 34 pt, `#2EC4B6` (Teal). X: 0.5", Y: 1.4".

**Tagline:** `Mid-P runs hotter and faster than any other EN class. It is slightly more forgiving of marginal cleaning -- but "more forgiving" still means skip plating if the surface is dirty.` -- Barlow SemiBold, 20 pt, `#F0EDE8` at 65%. X: 0.5", Y: 2.1".
...
| ENIG (PCB) note | Cleaner/conditioner preps dielectric for catalyst adsorption |
...
- Disclaimer: `This poster is an educational reference tool. Process parameters shown are typical industry values for alkaline soak cleaning prior to electroless nickel mid phosphorus (5-9% P) plating. Specific formulations, concentrations, and process limits vary by proprietary product. Consult your process supplier for application-specific guidance. Source: General industry knowledge; ASTM B733.`
- Title: `Cleaning -- EN (Mid Phos)`
...
Standard remap (same as all cluster posters). Tank walls `#C8D0D8` unchanged.
...
|---|---|---|
| `Cleaning EN Mid-P -- Dark -- 24x36 -- Print.pdf` | 300 DPI | Yes |
| `Cleaning EN Mid-P -- Dark -- 18x24 -- Print.pdf` | 300 DPI | Yes |
| `Cleaning EN Mid-P -- Dark -- Digital.pdf` | Standard | No |
| `Cleaning EN Mid-P -- Light -- 24x36 -- Print.pdf` | 300 DPI | Yes |
| `Cleaning EN Mid-P -- Light -- 18x24 -- Print.pdf` | 300 DPI | Yes |
| `Cleaning EN Mid-P -- Light -- Digital.pdf` | Standard | No |

---

## Design Notes

Cleaning for Mid-P is chemically identical to Low-P. The key differentiator for this poster is the ENIG callout: in PCB ENIG lines, the "cleaner" is actually a cleaner/conditioner that also preps the dielectric surface for Pd catalyst adsorption. The tagline should convey that Mid-P's higher operating temperature gives it slightly more latitude on cleaning -- but skip plating is still the #1 defect in all EN operations.

---

*Alaina -- Poster #224 -- Construction Workup v1.0 -- 2026-04-26*
