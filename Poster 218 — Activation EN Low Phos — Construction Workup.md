...
Poster Number: 218
Title: "Activation -- EN (Low Phos)"
Document Type: Construction Workup
Status: v1.0 -- Ready for Generation
Created: 2026-04-26T00:00:00
Author: Alaina (alaina-poster-designer)
Source Documents:
  - "Electroless Clusters -- Watson Research Brief (Process 1: EN Low-P, Poster 4)"
Process Scope: Activation for electroless nickel low phosphorus line (Stage 3 of 7)
...
# Poster #218 -- Construction Workup
## Activation -- EN (Low Phos)

*Alaina -- Plating Posters Inc Creative Lead*
*v1.0 -- 2026-04-26*

Stage 3 of the EN Low-P process. Activation for electroless nickel is more nuanced than for electroplating because the autocatalytic reaction will not start on a passive surface. The activation method depends entirely on the substrate: steel is self-catalytic (just needs oxide removal), aluminum requires zincate, copper is catalytic, non-conductors need colloidal Pd/Sn, and stainless steel may need a Wood's nickel strike.

Hero visual: substrate decision tree showing the activation path for each material type.
...
### Limitations to Flag
1. **Substrate decision tree hero (Block B):** A branching flowchart: substrate type at top, branches to specific activation protocols. Built with rectangles and connecting lines.
2. **Orientation strip (Block C):** Stage 3 highlighted.
3. **Zincate detail panel (Block E):** The double-zincate process for aluminum -- the most complex activation path.
4. **H-embrittlement warning (Block G):** Prominent safety callout for high-strength steel.
...
**Subheading:** `EN (Low Phos) -- Stage 3 of 7` -- Barlow SemiBold, 34 pt, `#E8A020` (Amber). X: 0.5", Y: 1.4".

**Tagline:** `The substrate decides the activation. Steel is easy. Aluminum needs zincate. Plastic needs palladium. Know your material, know your path.` -- Barlow SemiBold, 20 pt, `#F0EDE8` at 65%. X: 0.5", Y: 2.1".
...
Five branch boxes below, connected by vertical lines from question box:

**Branch 1 -- Steel / Iron (X: 0.5", Y: 7.0", W: 4.2", H: 5.5"):**
...
**Branch 2 -- Aluminum (X: 5.1", Y: 7.0", W: 4.2", H: 5.5"):**
- Top accent `#E8A020`
...
**Branch 3 -- Copper / Brass (X: 9.7", Y: 7.0", W: 4.2", H: 5.5"):**
- Top accent `#2EC4B6`
- Title: `COPPER / BRASS` Barlow SemiBold 18 pt `#2EC4B6`
- `H2SO4 10-20%, ambient, 30-60 sec`
- `Copper is catalytic -- no Pd needed`
- `Tarnished Cu: bright dip in HNO3 + H2SO4 first`

**Branch 4 -- Stainless Steel (X: 14.3", Y: 7.0", W: 4.2", H: 5.5"):**
- Top accent `#E8A020`
- Title: `STAINLESS STEEL` Barlow SemiBold 18 pt `#E8A020`
- `Wood's nickel strike recommended:`
- `NiCl2 240 g/L + HCl 125 mL/L`
- `25-35 ASF, 3-5 min`
- `Or: HCl 20-50%, 1-2 min, quick transfer`

**Branch 5 -- Plastics / Non-Conductors (X: 18.9", Y: 7.0", W: 4.6", H: 5.5"):**
- Top accent `#E05C5C`
- Title: `PLASTICS / CERAMICS` Barlow SemiBold 18 pt `#E05C5C`
...
| Dark smut on surface | Residue visible after activation | Carbon smut from high-C steel or cast iron | Add desmut step; use proprietary de-smutter |
...
Standard footer. Title: `Activation -- EN (Low Phos)`. Version `v1.0 -- 2026`.
...
**Grouping:** 7 zones.
**Light Remap:** Standard table. H-embrittlement border `#E05C5C` -> `#B83E3E`.
**Export:** Six files -- `Activation EN Low-P -- {Dark,Light} -- {24x36,18x24,Digital}`.

---

*Alaina -- Poster #218 -- Construction Workup v1.0 -- 2026-04-26*
